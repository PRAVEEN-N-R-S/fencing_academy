<?php
// PHP basics demo: types, strings, numbers, arrays, loops, functions
...
hr('Loop: foreach (value) —  like JS for...of');
foreach ($arr as $value) {
	echo "value: $value\n";
}

hr('Loop: foreach (key => value) —  like JS for...in');
...
hr('Conclusion');
echo "This file demonstrates PHP basics: strings, numbers, arrays, loops (for, foreach, while, do-while), functions and common helpers.\n";
